...
parser.add_argument("--sw_batch_size", default=16, type=int, help="")
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_loader):
            ...
            for i in range(1, 14):
                ...
                dice_organs[i].append(organ_Dice)
            ...
            # )
        for i in range(1,14):
            print('Overall Mean Dice of class {} {}'.format(i,np.mean(dice_organs[i])))
