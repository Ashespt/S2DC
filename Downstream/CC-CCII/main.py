...
parser.add_argument("--data_ratio", default=1.0, type=float, help="data ratio")
...
parser.add_argument("--use_v2", default=False, type=bool, help="distributed backend")
...
def main_worker(gpu, args):
    ...
    if args.use_ssl_pretrained:
        try:
            ...
            print(f"load pretrained model from {args.pretrained_checkpoint}")
